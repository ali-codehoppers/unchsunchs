...
public class HotWorksGenerator : GenericGenerator
{
     ...
     protected override void GenerateDocument(Document doc,DocumentType docType,PdfWriter writer)
    {
        ...
        Font normalFontSmall = FontFactory.GetFont("Arial", 7, Font.NORMAL);
        Font normalFontLarge = FontFactory.GetFont("Arial", 8, Font.NORMAL);
        Font boldFontSmall = FontFactory.GetFont("Arial", 7, Font.BOLD);
        Font boldFontLarge = FontFactory.GetFont("Arial", 8, Font.BOLD);
