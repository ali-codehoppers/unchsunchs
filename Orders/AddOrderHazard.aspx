...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <div class="text_field">        
        <asp:TextBox ID="tbHazard" runat="server" Rows="3" TextMode="MultiLine" width="780"></asp:TextBox>
    ...
    <div class="button_bar">
        <asp:Button ID="btnAddHazard" OnClick="btnAddHazard_Click" runat="server" Text="Add Hazard"
            ValidationGroup="Hazard" ></asp:Button>    
        <input type="button" value="Key Hazards List" onclick="document.getElementById('hazardDialog').style.display='block';hazardDialog.show();" />        
    </div>
    <!--<div class="grid_area">-->
    <div class="grid">
