    ...
    <div style="width:100%">
        <div class="transferArea">
            <fieldset>
                ...
                <div class="grid">
                    <asp:GridView ID="gvPPE1" runat="server" CssClass="grid_table"
                    PageSize="50" AllowPaging="True" 
                        AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="sequence" 
                        onrowcommand="gvPPE1_RowCommand" >
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="PPE" SortExpression="name_desc">
                                <ItemTemplate>
                                    <asp:Label ID="lblPPE1" runat="server" Text='<%# Bind("name_desc") %>'></asp:Label>
                                    <asp:HiddenField ID="hfPPEId1" runat="server" Value='<%# Bind("sequence") %>'/>
                                </ItemTemplate>
                            </asp:TemplateField>
        ...
        <div class="transferArea">            
            <fieldset>
                ...
                <div class="grid">
                    <asp:GridView ID="gvPPE2" runat="server" CssClass="grid_table"
                    PageSize="50" AllowPaging="True" 
                        AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="sequence" onrowcommand="gvPPE2_RowCommand" >
                        <PagerStyle CssClass="grid_pager" />
                        <Columns>
                            <asp:TemplateField HeaderText="Transfer" >
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Category" InsertVisible="False" 
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("category_name") %>'></asp:Label>
                                    <asp:HiddenField ID="hfPPEId2" runat="server" Value='<%# Bind("sequence") %>'/>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="PPE" SortExpression="name_desc">
                                <ItemTemplate>
                                    <asp:Label ID="lblPPE2" runat="server" Text='<%# Bind("name_desc") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
