<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true"
    CodeFile="DepartmentPPEList.aspx.cs" Inherits="Maintenance_DepartmentPPEList"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <div style="background-color: White; padding: 15px 10px 25px 10px; min-height: 590px;">
        <div class="ddl_field" style="padding-bottom: 5px">
            ...
            <asp:DropDownList ID="ddlDepartment" runat="server" CssClass="dropdown_txt" DataSourceID="odsDepartment"
        ...
        <div class="ddl_field" style="padding-bottom: 5px">
            ...
            <asp:DropDownList ID="ddlCategory" runat="server" CssClass="dropdown_txt" DataSourceID="odsCategories"
        ...
        <div class="text_field" style="padding-bottom: 5px">
            <div style="float: left; width: 200px">
                <span style="font-weight: bold">PPE:</span>
            </div>
        ...
        <div class="button_bar">
            ...
            <div style="float: left; height: 23px; padding-top: 8px; background-image: url('<%=this.ResolveClientUrl("~/images/btn_submit_mid.jpg")%>')">
                <asp:LinkButton ID="btnAdd" runat="server" CssClass="txt_white" OnClick="btnAdd_Click"
                    ValidationGroup="Top">Add PPE</asp:LinkButton>
                <asp:LinkButton ID="btnUpate" runat="server" CssClass="txt_white" OnClick="btnUpate_Click"
                    Text="Update PPE" Visible="False" ValidationGroup="Top"></asp:LinkButton>
            </div>
            <div style="float: left">
        ...
        <div class="button_bar">
            ...
            <div style="float: left; height: 23px; padding-top: 8px; background-image: url('<%=this.ResolveClientUrl("~/images/btn_submit_mid.jpg")%>')">
                <asp:LinkButton ID="btnSave" runat="server" OnClick="btnSave_Click" CssClass="txt_white"
        ...
        <div class="workArea">
            <asp:Repeater ID="repeater" runat="server" DataSourceID="odsDepartmentPPE" OnItemCommand="repeater_ItemCommand">
                <HeaderTemplate>
                    ...
                    <ul id="dragDropUL" class="draglist" style="width: 100%; list-style: none;">
                </HeaderTemplate>
                <ItemTemplate>
                    <li class="table_header_result" style="height: 30px" id="li_<%#DataBinder.Eval(Container.DataItem, "sequence")%>">
                        ...
                        <!--</div>-->
                        <!--<div class="liData">-->
                        <asp:ImageButton ID="btnDelete" runat="server" ImageUrl="~/Images/icon_cancel.png"
                            AlternateText="Delete" CommandName="Delete" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "sequence")%>'
        ...
        <asp:ObjectDataSource ID="odsDepartmentPPE" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="GetDepartmentPPEByDeptId" TypeName="DepartmentPPETableAdapters.DepartmentPPESelectCommandTableAdapter"
            DeleteMethod="Delete">
            <SelectParameters>
        ...
        <asp:ObjectDataSource ID="odsCategories" runat="server" OldValuesParameterFormatString="original_{0}"
            ...
            <SelectParameters>
                ...
                <asp:Parameter DefaultValue="P" Name="category_type" Type="String" />
            </SelectParameters>
        </asp:ObjectDataSource>
    </div>
