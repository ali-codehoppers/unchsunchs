<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true"
    CodeFile="DepartmentRequirementList.aspx.cs" Inherits="Maintenance_DepartmentRequirementList"
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <div style="background-color: White; padding: 15px 10px 25px 10px; min-height: 590px;">
        <uc1:SuggestionsControl ID="SuggestionsControl1" runat="server" CategoryType="R"
            SuggestionType="R" EntityName="Requirement" />
    </div>
