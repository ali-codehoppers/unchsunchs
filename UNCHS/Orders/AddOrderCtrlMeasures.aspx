...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <div class="field">
        <span class="heading">Control Measure:</span>
    </div>
    <div class="field">
        <asp:TextBox ID="tbControl" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="tbControl"
            ErrorMessage="*" ValidationGroup="Control"></asp:RequiredFieldValidator>
    </div>
    <div class="button_bar">
        <asp:Button ID="btnAddControl" runat="server" Text="Add" Width="100px" OnClick="btnAddControl_Click"
            ValidationGroup="Control" />
    </div>
    <div class="grid">
        <asp:GridView Width="75%" ID="gvControl" runat="server" AllowPaging="True" AllowSorting="True"
            AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid"
            BorderWidth="1px" CellPadding="3" DataKeyNames="sequence" DataSourceID="odsControl"
            ForeColor="Black" GridLines="Vertical" OnRowDeleting="gvControl_RowDeleting"
            OnRowUpdating="gvControl_RowUpdating" PageSize="50">
            <Columns>
                ...
                <asp:BoundField DataField="control_measure_desc" HeaderText="Description" SortExpression="control_measure_desc" />
            </Columns>
    ...
    <asp:ObjectDataSource ID="odsControl" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetAllControlMeasures" TypeName="DepartmentOrderDetailTableAdapters.DepartmentOrderControlMeasureTableAdapter"
        ...
        <UpdateParameters>
            <asp:Parameter Name="control_measure_desc" Type="String" />
            <asp:Parameter Name="user_id" Type="Int32" />
            <asp:Parameter Name="sequence" Type="Int32" />
