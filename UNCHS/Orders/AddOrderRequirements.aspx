...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <div style="background-color: White; padding: 15px 10px 25px 10px; min-height: 240px;">
        <uc1:SuggestionsSelectControl ID="suggestionsSelectControl" runat="server" EntityName="Sequence of Work"
            SuggestionType="R" ImageName="Add_requirement" />
        ...
        <div class="field">
            <span class="heading"><strong>Client/Site Specific Requirements:</strong></span>
        </div>
        <div class="text_field">
            <asp:TextBox ID="tbRequirementTitle" runat="server" Rows="5" TextMode="MultiLine"
        ...
        <div class="grid">
            <asp:GridView ID="gvRequirement" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" CssClass="table_header_result" DataKeyNames="sequence" DataSourceID="odsClient"
                OnRowDeleting="gvRequirement_RowDeleting" OnRowUpdating="gvRequirement_RowUpdating"
        ...
        <div class="button_bar">
            <div class="button_right" style="padding-left: 340px;">
                ...
                <div style="float: left; height: 23px; padding-top: 8px; background-image: url('<%=this.ResolveClientUrl("~/images/btn_submit_mid.jpg")%>')">
                    <asp:LinkButton ID="btnAddRequirement" runat="server" OnClick="btnAddRequirement_Click"
                        ValidationGroup="Requirement" CssClass="txt_white">Add Requirement</asp:LinkButton>
                </div>
                <div style="float: left">
                ...
                <div style="float: left; height: 23px; padding-top: 8px; background-image: url('<%=this.ResolveClientUrl("~/images/btn_submit_mid.jpg")%>')">
                    <a href="" class="txt_white" onclick="document.getElementById('suggestionDialog').style.display='block';suggestionDialog.show();return false;"
                        style="margin-right: 10px; margin-left: 5px">Requirements List</a>
                </div>
