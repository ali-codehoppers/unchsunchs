...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <div style="background-color: White; padding: 15px 10px 25px 10px">
        <div id="copyDialog" style="display: none">
            ...
            <div class="bd">
                ...
                <div class="text_field" style="padding-left:125px">
        ...
        <div class="field">
            <div style="float: left">
                <asp:Label ID="lblDepartment" CssClass="label" runat="server" Text="Department:"
                    Style="width: 110px;"></asp:Label><asp:DropDownList ID="ddlDepartments" runat="server"
                        AppendDataBoundItems="True" DataSourceID="odsDepartments" DataTextField="co_name_short"
                        DataValueField="dept_id" OnDataBound="ddlDepartments_DataBound" CssClass="ddl_margin"
                        Width="155px">
                    </asp:DropDownList>
            </div>
    ...
    <div class="field">
        ...
        <div style="width: 200px; float: left">
         <span class="label"
            style="width: 40px;"><strong>From:</strong></span>
            </div>
            <div style="padding-bottom:5px;"><ww:jQueryDatePicker ID="tbDateFrom" runat="server"
                DisplayMode="AutoPopup" CssClass="field_txt"></ww:jQueryDatePicker>
    </div>
    <div class="field">
       <div style="width: 200px; float: left"> <span class="label" style="width: 25px;"><strong>To:</strong></span></div><div><ww:jQueryDatePicker ID="tbToDate"
            runat="server" DisplayMode="AutoPopup" CssClass="field_txt"></ww:jQueryDatePicker>
    </div>
