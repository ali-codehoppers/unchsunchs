...
public partial class Orders_GenerateCOSHH : DepartmentPage
{
    ...
    {
        DepartmentOrderDoc.DocumentTypeEntityRow docType = DatabaseUtility.GetDocumentType(loggedInUserCoId, int.Parse(ddlDepartments.SelectedValue), "COSHH Documents");
        if (docType != null)
        {
