...
<asp:Content ContentPlaceHolderID="HeadingPlaceHolder" ID="ContenPlaceHolder2" runat="server">
    Default Department Tool List</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <div class="text_field">
        <span style="width:100px;">Tool:</span><asp:TextBox ID="tbName" runat="server" ></asp:TextBox><asp:RequiredFieldValidator
        ...
        <div class="button_bar">
            <asp:Button ID="btnAdd" runat="server" Text="Add Tool" OnClick="btnAdd_Click" ValidationGroup="Top" />
