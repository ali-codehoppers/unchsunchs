...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <div class="text_field">
        <asp:TextBox ID="tbRequirementTitle" runat="server" Rows="3" TextMode="MultiLine" width="780"></asp:TextBox>
    ...
    <div class="button_bar">
        <asp:Button ID="btnAddRequirement" runat="server" Text="Add Requirement" OnClick="btnAddRequirement_Click"
            ValidationGroup="Requirement" />
    </div>
    <div class="grid">
