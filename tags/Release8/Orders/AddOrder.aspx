...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContentPlaceHolder" runat="Server">
    ...
    <style type="text/css">
        .text_field span{width:250px;height:100%;display:inline-block;}    
        .field span{width:250px;display:inline-block;}    
    </style>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <div class="text_field">
        <span >SMS Ref:</span><asp:TextBox ID="tbOrderSMS" runat="server"
    ...
    <div class="field">
        <span >Review Date:</span><asp:CheckBox ID="cbReview" runat="server"
            AutoPostBack="true" OnCheckedChanged="cbReview_CheckedChanged"  /><ww:jQueryDatePicker
                ID="dtReview" runat="server" DisplayMode="AutoPopup" Enabled="false"></ww:jQueryDatePicker></div>
   ...
   <div class="text_field">
        <span >Postal Code:</span><asp:TextBox ID="tbPostalCode" runat="server"></asp:TextBox></div>
    <div class="text_field">
        <table border="0" cellpadding="0" cellspacing="0">
        <tr>
