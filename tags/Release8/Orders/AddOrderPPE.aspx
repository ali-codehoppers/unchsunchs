...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
   ...
   <div class="button_bar">
        <asp:Button ID="btnAddPPE" runat="server" Text="Add PPE" OnClick="btnAddPPE_Click"
            ValidationGroup="PPE" />
   
        <input type="button" value="PPE List" onclick="document.getElementById('ppeDialog').style.display='block';ppeDialog.show();" id="Button1" />
    </div>    
    <div class="grid">
