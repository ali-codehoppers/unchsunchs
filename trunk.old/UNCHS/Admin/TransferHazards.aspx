<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="TransferHazards.aspx.cs" Inherits="Admin_TransferHazards" Title="Simplicity4Business" %>
    ...
    <div style="width:100%">
        <div class="transferArea">
            <fieldset>
                ...
                <div class="grid">
                    <asp:GridView ID="gvHazards1" runat="server" CssClass="grid_table"
                    PageSize="50" AllowPaging="True" 
                        AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="sequence" 
                        onrowcommand="gvHazards1_RowCommand" >
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Hazard" SortExpression="name_desc">
                                <ItemTemplate>
                                    <asp:Label ID="lblHazard1" runat="server" Text='<%# Bind("name_desc") %>'></asp:Label>
                                    <asp:HiddenField ID="hfHazardId1" runat="server" Value='<%# Bind("sequence") %>'/>
                                </ItemTemplate>
                            </asp:TemplateField>
        ...
        <div class="transferArea">            
            <fieldset>
                ...
                <div class="grid">
                    <asp:GridView ID="gvHazards2" runat="server" CssClass="grid_table"
                    PageSize="50" AllowPaging="True" 
                        AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="sequence" onrowcommand="gvHazards2_RowCommand" >
                        <PagerStyle CssClass="grid_pager" />
                        <Columns>
                            <asp:TemplateField HeaderText="Transfer" >
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Category" InsertVisible="False" 
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("category_name") %>'></asp:Label>
                                    <asp:HiddenField ID="hfHazardId2" runat="server" Value='<%# Bind("sequence") %>'/>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Hazard" SortExpression="name_desc">
                                <ItemTemplate>
                                    <asp:Label ID="lblHazard2" runat="server" Text='<%# Bind("name_desc") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
