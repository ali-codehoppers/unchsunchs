<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="TransferTool.aspx.cs" Inherits="Admin_TransferTool" Title="Simplicity4Business" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadingPlaceHolder" Runat="Server">
     Transfer Plants &amp; Tools 
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder" Runat="Server">
    <div style="width:100%">
        <div class="transferArea">
            <fieldset>
                <legend>Plants &amp; Tools List</legend>
                <div class="ddl_field">
                    <span>Company:</span>
