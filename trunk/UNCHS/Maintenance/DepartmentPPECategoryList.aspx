<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true"
    CodeFile="DepartmentPPECategoryList.aspx.cs" Inherits="Maintenance_DepartmentPPECategoryList"
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <div style="background-color: White; padding: 15px 10px 25px 10px; min-height: 590px;">
        <uc1:CategoryControl ID="CategoryControl1" runat="server" CategoryType="P"></uc1:CategoryControl>
    </div>
