<%@ Page Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="AddOrderDocuments.aspx.cs" Inherits="Orders_AddOrderDocuments" Title="Simplicity4Business" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" Runat="Server">        
        ...
        <asp:Repeater ID="rptDocTypes" runat="server" DataSourceID="odsDocTypes">
            <ItemTemplate>
                <div class="field" style='<%#DataBinder.Eval(Container.DataItem, "style")%>'>
                    ...
                    <asp:CheckBox ID="cbDocType" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "doc_data_type_desc")%>' checked='<%#DataBinder.Eval(Container.DataItem, "flg_checked")%>' ></asp:CheckBox>
                    <asp:Label runat="server" ID="Label123" Visible='<%# AreEqual(DataBinder.Eval(Container.DataItem,"field_type"),"int") %>' Text="Number of Copies:" Width="120px"></asp:Label>
	...
	<asp:ImageButton ID="btnCreate" runat="server" OnClick="btnCreate_Click" OnClientClick="showLoading();" ImageUrl="~/Images/Create_Folder.gif" onmouseover="this.src='../Images/Create_folder_roll_selec.gif';" onmouseout="this.src='../Images/Create_Folder.gif';" style="margin-right: 10px; margin-left: 5px"/>
            ...
            SelectMethod="GetDocTypeByDeptIdAndCategory" 
