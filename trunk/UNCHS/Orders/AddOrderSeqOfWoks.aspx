...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <div class="warning_text">
        Data may go to continuation sheet if it exceeds the number of recods.</div>
    <div class="field">
    ...
    <div style="text-align: right; margin-top: 10px">
        <asp:ImageButton ID="btnAddWork" runat="server" ImageUrl="~/Images/Add_sequence_of_work.gif"
            OnClick="btnAddWork_Click" onmouseover="this.src='../Images/Add_Sequence_of_work_rol_sel.gif';"
            onmouseout="this.src='../Images/Add_sequence_of_work.gif';" ValidationGroup="Work" />
        <input type="image" src="../Images/Sequence_works_list.gif" onmouseover="this.src='../Images/Sequence_works_list_rollove.gif';"
            onmouseout="this.src='../Images/Sequence_works_list.gif';" onclick="document.getElementById('suggestionDialog').style.display='block';suggestionDialog.show();return false;"
